...
CREATE TABLE `booking_details` (
  ...
  CONSTRAINT `booking_details_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `city` (`city_id`),
  CONSTRAINT `booking_details_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotels` (`hotel_id`),
  CONSTRAINT `booking_details_ibfk_3` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`vehicle_id`),
  CONSTRAINT `booking_details_ibfk_4` FOREIGN KEY (`place_id`) REFERENCES `place` (`place_id`)
...
INSERT INTO `booking_details` VALUES (4,1,NULL,1,'2024-08-20','2024-08-30',16728,'yes','2024-08-15',1,1,1,1),(47,35,NULL,1,'2025-02-13','2025-02-28',5700,'yes','2025-02-09',1,2,16,1),(48,35,NULL,5,'2025-02-22','2025-02-28',28500,'yes','2025-02-09',1,2,16,1),(49,38,NULL,2,'2025-02-11','2025-02-13',24200,'yes','2025-02-10',1,2,5,5),(50,38,NULL,2,'2025-02-11','2025-02-13',24200,'yes','2025-02-10',1,2,5,5);
...
INSERT INTO `personal_details` VALUES (1,'8652336784','asad.png','2002-08-20','male','married','1234 5432 7654',1,NULL),(4,'8652336777','sohel.png','2002-08-01','male','unmarried','0987 7890 7654',4,NULL),(6,'9876543210','profile_pic_9.jpg','2025-02-12','M','Divorced','123456789012',9,'A1234567'),(7,'9876543211','profile_pic_10.jpg','1991-02-01','F','Married','123456789013',10,'A1234568'),(9,'9876543213','profile_pic_12.jpg','1993-04-01','F','Married','123456789015',12,'A1234570'),(11,'9876543215','profile_pic_14.jpg','1995-06-01','F','Married','123456789017',14,'A1234572'),(23,'1234567890',NULL,'1989-12-19','Male','Single','1234-5678-9012',34,'A1234567'),(54,'446',NULL,'2002-04-29','Male','Single','fgsonusgue',35,'seffuhuhuhuh');
...
INSERT INTO `user` VALUES (1,'asad@g.c','asad','sayyad','asad123','User','2024-12-12 10:11:13','2025-02-09 08:52:08','active'),(4,'sohel@g.c','sohel','momin','sohel786','User','2024-12-12 10:13:48','2025-02-09 08:52:08','active'),(9,'test@222','test2','test2',NULL,'User','2024-12-27 17:32:26','2025-02-09 08:52:08','active'),(10,'johnytest@gmail.com','johny','test','43df1b4f71d0d4e214b62eb8f871249ca4fb866f27550cce1d5967899969a214','User','2024-12-27 18:29:43','2025-02-09 08:52:08','active'),(11,'manager@gmail.com','asad','sayyad','123','manager','2024-12-28 03:19:04','2025-02-09 08:54:46','active'),(12,'admin@gmail.com','admin','shaikh','5474996ab446f9c2579656192e111dfe18775cc57ccd516d52b9722d9e1af24b','User','2024-12-28 03:37:22','2025-02-09 08:52:08','active'),(14,'manag@gmail.com','manag','ger','48b676e2b107da679512b793d5fd4cc4329f0c7c17a97cf6e0e3d1005b600b03','User','2024-12-30 17:21:40','2025-02-09 08:52:08','active'),(34,'asadsayyad208@gmail.com','Asad','Sayyad','ba83f79d43537a525eb5a38096b56f2fbee05fffdacb6ec9271b0c24b08dce24','admin','2025-02-08 20:11:14','2025-02-09 08:54:06','active'),(35,'managertest@t.c','travent','manager','48b676e2b107da679512b793d5fd4cc4329f0c7c17a97cf6e0e3d1005b600b03','User','2025-02-09 08:55:44','2025-02-09 08:55:44','active'),(37,'newasad@g.c','asad','new','ba83f79d43537a525eb5a38096b56f2fbee05fffdacb6ec9271b0c24b08dce24','User','2025-02-09 18:54:22','2025-02-09 18:54:22','active'),(38,'new2@g.c','new2','new2','11507a0e2f5e69d5dfa40a62a1bd7b6ee57e6bcd85c67c9b8431b36fff21c437','User','2025-02-09 18:55:21','2025-02-09 18:55:21','active');
...
INSERT INTO `wishlist` VALUES (13,11,NULL,4),(18,11,NULL,5),(24,9,NULL,2),(25,34,NULL,6),(29,35,NULL,1),(30,35,NULL,4),(31,35,NULL,2),(32,38,NULL,5);
...
-- Dump completed on 2025-02-10 11:38:39
